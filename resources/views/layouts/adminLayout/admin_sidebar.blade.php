...
<aside class="main-sidebar elevation-4" style="background:#000000;color:white;">
    <a href="{{ url('/admin/dashboard') }}" class="brand-link text-white p-2">
        <img src="{{asset('assets/images/DeepDiveGoa-Logo.svg')}}" class="brand-image" style="width:70%;">
    </a>
    <div class="sidebar">        
        <nav class="mt-1">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item d-none">
                    <a href="{{url('/admin/view-blogs/')}}" class="nav-link text-white ">
                        <i class="nav-icon fas fa-user-cog"></i>
                        <p>Blogs</p>
                    </a>
                </li> 
                ...
                <li class="nav-item">
                    <a href="{{url('admin/view-joinus-enq')}}" class="nav-link text-white ">
                        <i class="nav-icon fas fa-user-cog"></i>
                        <p>Contact Enquiry</p>
                    </a>
                </li>
